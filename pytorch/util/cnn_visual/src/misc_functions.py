...
<<<<<<< HEAD
# def save_image(tensor, filename, imtype=np.uint8, mode='RGB'):
...
#         image_save = Image.fromarray(np.squeeze(image_numpy), mode=mode).convert(mode='I')
#         if use_padding:
...
# def save_output_convolution(output):
#     self.save_image(output.data, '{}/output/output_{:04}.png'.format(self.save_samples_path, index), imtype=np.uint16, mode='I;16')

=======
>>>>>>> 1050d9cd7bf9b36e200a8be4b70b581fa5876e22
